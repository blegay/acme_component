...
If ($vl_hstsMode=0)
	acme__moduleDebugDateTimeLine (4;Current method name:C684;"HSTS mode was not activated, enabled")
	WEB SET OPTION:C1210(Web HSTS enabled:K73:26;1)
Else 
	acme__moduleDebugDateTimeLine (2;Current method name:C684;"HSTS mode is already activated")
End if 