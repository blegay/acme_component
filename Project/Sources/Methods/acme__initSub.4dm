...
acme__moduleDebugDateTimeLine (4;Current method name:C684;"component acme v"+acme_componentVersionGet +"("+$vt_environmentText+") init")

acme__moduleDebugDateTimeLine (4;Current method name:C684;"cipher list : \""+acme_sslCipherListGet +"\"")
...
If (Length:C16(<>vt_ACME_workingDir)=0)
	...
	acme__moduleDebugDateTimeLine (4;Current method name:C684;"\"workingDir\" default : \""+<>vt_ACME_workingDir+"\"")
End if 

If (Length:C16(<>vt_ACME_directoryUrl)=0)
	<>vt_ACME_directoryUrl:="https://acme-v02.api.letsencrypt.org/directory"
	acme__moduleDebugDateTimeLine (4;Current method name:C684;"\"directoryUrl\" default : \""+<>vt_ACME_directoryUrl+"\"")
End if 

acme__moduleDebugDateTimeLine (4;Current method name:C684;"assertions : "+Choose:C955(Get assert enabled:C1130;"enabled";"disabled"))
