...
If ((Test path name:C476($vt_keyPubPath)=Is a document:K24:1) & (Test path name:C476($vt_keyPrivPath)=Is a document:K24:1))
	...
	acme__log (6;Current method name:C684;"account already registered (files \""+$vt_filenamebase+".pem\" and \""+$vt_filenamebase+".pub\" exist in \""+$vt_certDir+"\"). Continuing.")
	
Else 
	acme__log (4;Current method name:C684;"Starting new account registration (files \""+$vt_filenamebase+".pem\" and \""+$vt_filenamebase+".pub\" do not exist in \""+$vt_certDir+"\")")
