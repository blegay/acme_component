...
acme__moduleDebugDateTimeLine (4;Current method name:C684;"http server infos :\r"+$vt_serverInfosJson)
...
If (acme_certCurrentGet (->$vt_cert))
	...
	acme__moduleDebugDateTimeLine (4;Current method name:C684;"certificate chain :\r"+$vt_certText)
End if 
